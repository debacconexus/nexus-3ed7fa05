...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "AWS Bedrock Software Defect Tracking";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Software Defect";
process.env.TABLE_NAME = process.env.TABLE_NAME || "software_defect_records";
'use strict';
